...
PRODUCT_BUILD_PROP_OVERRIDES += \
    PRODUCT_NAME=mojo \
    TARGET_DEVICE=mojo \
    BUILD_FINGERPRINT="MadCatz/lineage_mojo/mojo:11/RQ3A.211001.001/$(date +%s):userdebug/release-keys" \
    PRIVATE_BUILD_DESC="lineage_mojo-userdebug 11 RQ3A.211001.001 $(date +%s) release-keys"
